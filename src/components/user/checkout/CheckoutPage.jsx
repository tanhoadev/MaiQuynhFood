...
function CheckoutPage() {
    ...
    const [houseNumber, setHouseNumber] = useState('123 Đường Trường Chinh')
    const [receiverName, setReceiverName] = useState()
    const [phoneNumber, setPhoneNumber] = useState('0911927898')
    const [email, setEmail] = useState('soc033535@gmail.com')
    const [name, setName] = useState('Lê Quang Minh Quân')
    const [moreInfo, setMoreInfo] = useState('Giao hàng nhanh nhé')
